...
var regions = require('../../controllers/Regions.js');
...
describe('Regions controller', function(){
    ...
    it('should build projection', function(done){
        ...
        var project = regions.buildProjection(projection);
...
it('should update a document', function(done){
    ...
    regions.updateOne(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    regions.deleteOne(req, res, next);
});
