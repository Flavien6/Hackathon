...
var secteurs = require('../../controllers/Secteurs.js');
...
describe('Secteurs controller', function(){
    ...
    it('should build projection', function(done){
        ...
        var project = secteurs.buildProjection(projection);
...
it('should find one document', function(done){
    ...
    var req = {};
    req.params = {};
    req.params.id = secteurId;
    secteurs.findOne(req, res, next);
});
...
it('should update a document', function(done){
    ...
    secteurs.updateOne(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    secteurs.deleteOne(req, res, next);
});
