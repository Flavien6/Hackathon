...
var entrepots = require('../../controllers/Entrepots.js');
...
describe('Entrepots controller', function(){
    ...
    it('should build projection', function(done){
        ...
        var project = entrepots.buildProjection(projection);
...
it('should find one document', function(done){
    ...
    var req = {};
    req.params = {};
    req.params.id = entrepotId;
    entrepots.findOne(req, res, next);
});
...
it('should update a document', function(done){
    ...
    entrepots.updateOne(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    entrepots.deleteOne(req, res, next);
});
...
it('should restore a previously deleted data', function(done){
    ...
    entrepots.restore(req, res, next);
});
});
