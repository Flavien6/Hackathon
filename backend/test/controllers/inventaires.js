...
var inventaires = require('../../controllers/Inventaires.js');
...
describe('Inventaires controller', function(){
    it('should create documents', function(done){
        ...
        inventaires.create(req, res, next);
    });
    ...
    it('should build projection', function(done){
        ...
        var project = inventaires.buildProjection(projection);
...
it('should find one document', function(done){
    ...
    var req = {};
    req.params = {};
    req.params.id = inventaireId;
    inventaires.findOne(req, res, next);
});
it('should update documents', function(done){
    ...
    inventaires.update(req, res, next);
});
it('should update a document', function(done){
    ...
    inventaires.updateOne(req, res, next);
});
it('should delete multiple data', function(done){
    ...
    inventaires.delete(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    inventaires.deleteOne(req, res, next);
});
...
it('should restore a previously deleted data', function(done){
    ...
    inventaires.restore(req, res, next);
});
});
