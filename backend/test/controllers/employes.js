...
var employes = require('../../controllers/Employes.js');
...
describe('Employes controller', function(){
    ...
    it('should build projection', function(done){
        ...
        var project = employes.buildProjection(projection);
...
it('should find one document', function(done){
    ...
    var req = {};
    req.params = {};
    req.params.id = employeId;
    employes.findOne(req, res, next);
});
...
it('should update a document', function(done){
    ...
    employes.updateOne(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    employes.deleteOne(req, res, next);
});
