...
var emplois = require('../../controllers/Emplois.js');
...
describe('Emplois controller', function(){
    ...
    it('should build projection', function(done){
        ...
        var project = emplois.buildProjection(projection);
...
it('should find one document', function(done){
    ...
    var req = {};
    req.params = {};
    req.params.id = emploiId;
    emplois.findOne(req, res, next);
});
...
it('should update a document', function(done){
    ...
    emplois.updateOne(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    emplois.deleteOne(req, res, next);
});
