...
var debug = require('debug')('clientsController');
...
ClientsController.buildProjection = function(projections){
...
ClientsController.update = function(req,res,next){
    var query = req.query;
    var _query = {};
    // Clean appId and userId
    if(query && query.appId){
...
ClientsController.delete = function(req,res,next){ 
    var _query = {};
    var query = req.query;
    // Clean appId and userId
    if(query && query.appId){
...
ClientsController.restore = function(req,res,next){
    var id = req.params.id;
    // Find data by ID from trash 
    Trash.findById(id)
    .then(function(resp){
        // Restore to DB
        return Clients.create(resp.data);
    })
    .then(function(resp){
        // Delete from trash
