...
describe('Client Model',function(){
    ...
    describe('Client CRUDS', function(){
        ...
        it('should read data', function(done){
            var myclient = Client.findOne({where: {name: 'femi'}});
        ...
        it('should update data', function(done){
            var cb = sinon.spy();
            var myclient = Client.update({name: 'Olaoluwa'}, { where: {name: 'femi'}});
        ...
        it('should delete data', function(done){
            var cb2 = sinon.spy();
            var ourclient = Client.bulkCreate([{name:'Olaolu'},{name: 'fola'},{name: 'bolu'}]);

            ourclient.then(function(res){
                return Client.destroy({where: {name: 'bolu'}});
            }).then(function(res){
                cb2();
        ...
        it('should add updatedAt', function(done){
            ...
            myclient.then(function(res){
                id2 = res._id;
                return Client.update({name: 'This is the titan'}, {where: {_id: id}});
            })
            .then(function(res){
                return Client.findOne({where: {name: 'This is the titan'}});
            })
            .then(function(res){
        ...
        it('should tag database entries properly', async function(){
            ...
            setTimeout(function(){
                Client.findOne({where: {_id: myclient._id}})
                .then(function(res){
        ...
        it('should count returned records', function(done){
            var myclient = Client.count({where: {name: 'This is the titan'}});
        ...
        it('should find a record by id and delete', function(done){
            var myclient = Client.findOne({where: {_id: id2}});

            var clienter = myclient.then(function(res){
                return res.destroy();
            })
            .then(function(res){
        ...
        it('should have transaction object', function(done){
            var myclient = Client.transaction.should.exist;  /* jslint ignore:line */
            done();
        });
