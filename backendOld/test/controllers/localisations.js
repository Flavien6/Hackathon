...
var localisations = require('../../controllers/Localisations.js');
...
describe('Localisations controller', function(){
    it('should create documents', function(done){
        ...
        localisations.create(req, res, next);
    });
    ...
    it('should build projection', function(done){
        ...
        var project = localisations.buildProjection(projection);
    ...
    it('should search for matching documents for a given string', function(done){
        ...
        localisations.find(req, res, next);
    });
...
it('should find one document', function(done){
    ...
    var req = {};
    req.params = {};
    req.params.id = localisationId;
    localisations.findOne(req, res, next);
});
it('should update documents', function(done){
    ...
    localisations.update(req, res, next);
});
it('should update a document', function(done){
    ...
    localisations.updateOne(req, res, next);
});
it('should delete multiple data', function(done){
    ...
    localisations.delete(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    localisations.deleteOne(req, res, next);
});
...
it('should restore a previously deleted data', function(done){
    ...
    localisations.restore(req, res, next);
});
});
