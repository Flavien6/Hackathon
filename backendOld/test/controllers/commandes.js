...
var commandes = require('../../controllers/Commandes.js');
...
describe('Commandes controller', function(){
    ...
    it('should build projection', function(done){
        ...
        var project = commandes.buildProjection(projection);
...
it('should find one document', function(done){
    ...
    commandes.findOne(req, res, next);
});
...
it('should update a document', function(done){
    ...
    commandes.updateOne(req, res, next);
});
...
it('should delete one data', function(done){
    ...
    commandes.deleteOne(req, res, next);
});
...
it('should restore a previously deleted data', function(done){
    ...
    commandes.restore(req, res, next);
});
});
